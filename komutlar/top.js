...
exports.run = async (client, message, args) => {
  if(message.author.id !== "694493379869802587") return message.channel.send(new Discord.MessageEmbed().setColor("RANDOM").setDescription("Way Çakal Bu Sahibimin Komutu!"))
                 if(isNaN(args[0])){
